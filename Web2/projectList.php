...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample07">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./projectList.php">Projects</a>
                    </li>
    ...
    <div class="row" style="margin-top: 5.5rem;">
        <div class="col-md-6 col-sm-12 cards-margin">
            <div class="card">
                <div class="row">
                    <div class="col-md-4">
                        <img src="./extraImages/3.jpg" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Special title treatment</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus impedit qui quam ex quidem? Quod quis deserunt nulla exercitationem aliquam ea perferendis distinctio nisi officia, recusandae modi ullam rem quia aut dicta tempora
                                ex repellendus iste delectus! Nobis, ad accusamus. With supporting text below as a natural lead-in to additional content.</p>
        ...
        <div class="col-md-6 col-sm-12 cards-margin">
            <div class="card">
                <div class="row">
                    <div class="col-md-4">
                        <img src="./extraImages/4.jpg" class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Special title treatment</h5>
    ...
    <!-- PAGINATION -->
    <nav aria-label="Pagination" class="pagination-margin">
